...
if __name__ == "__main__":
    ...
    #     if filename == 'quench_st_Dataset_sph.nc':
    #         continue
    #     print(filename)
    ...
    # del(ds_tot.attrs['P']); del(ds_tot.attrs['aIBi']); del(ds_tot.attrs['nu']); del(ds_tot.attrs['gIB']); del(ds_tot.attrs['Pcrit'])
    # ds_tot.to_netcdf(innerdatapath + '/quench_st_Dataset_sph.nc')

    # # Analysis of Total Dataset

    qds = xr.open_dataset(innerdatapath + '/quench_st_Dataset_sph.nc')
    qds['NB'].sel(P=0.5).plot()
