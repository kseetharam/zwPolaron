...
if __name__ == "__main__":
    ...
    # CSAmp_ds = dynsph_ds[['Real_CSAmp', 'Imag_CSAmp']]; CSAmp_ds.attrs = dynsph_ds.attrs; CSAmp_ds.to_netcdf(nonintdatapath + '/P_{:.3f}_aIBi_{:.2f}.nc'.format(P, aIBi))  # real time evolution to get direct S(t)
